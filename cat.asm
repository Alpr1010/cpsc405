...
main(int argc, char *argv[])
{
  ...
  for(i = 1; i < argc; i++){
    ...
    1037:	e8 36 03 00 00       	call   1372 <open>
  ...
  for(i = 1; i < argc; i++){
    ...
    1057:	e8 fe 02 00 00       	call   135a <close>
  if(argc <= 1){
    cat(0);
    exit();
  }
  ...
  exit();
    1064:	e8 c9 02 00 00       	call   1332 <exit>
    exit();
  }
  ...
  for(i = 1; i < argc; i++){
    ...
    106c:	68 c1 17 00 00       	push   $0x17c1
    1071:	6a 01                	push   $0x1
    1073:	e8 18 04 00 00       	call   1490 <printf>
      exit();
    1078:	e8 b5 02 00 00       	call   1332 <exit>
main(int argc, char *argv[])
{
  int fd, i;
  ...
  if(argc <= 1){
    ...
    exit();
    1087:	e8 a6 02 00 00       	call   1332 <exit>
...
cat(int fd)
{
    ...
    1097:	8b 5d 08             	mov    0x8(%ebp),%ebx
  int n;

  while((n = read(fd, buf, sizeof(buf))) > 0)
    109a:	eb 17                	jmp    10b3 <cat+0x23>
    109c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    write(1, buf, n);
    10a0:	83 ec 04             	sub    $0x4,%esp
    10a3:	50                   	push   %eax
    10a4:	68 e0 1a 00 00       	push   $0x1ae0
    10a9:	6a 01                	push   $0x1
    10ab:	e8 a2 02 00 00       	call   1352 <write>
...
cat(int fd)
{
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0)
    ...
    10bb:	68 e0 1a 00 00       	push   $0x1ae0
    10c0:	53                   	push   %ebx
    10c1:	e8 84 02 00 00       	call   134a <read>
    10c6:	83 c4 10             	add    $0x10,%esp
    10c9:	83 f8 00             	cmp    $0x0,%eax
    10cc:	7f d2                	jg     10a0 <cat+0x10>
    write(1, buf, n);
  if(n < 0){
    10ce:	75 05                	jne    10d5 <cat+0x45>
    printf(1, "cat: read error\n");
    exit();
  }
}
    10d0:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    10d3:	c9                   	leave  
    10d4:	c3                   	ret    
  int n;
  ...
  if(n < 0){
    ...
    10d8:	68 b0 17 00 00       	push   $0x17b0
    10dd:	6a 01                	push   $0x1
    10df:	e8 ac 03 00 00       	call   1490 <printf>
    exit();
    10e4:	e8 49 02 00 00       	call   1332 <exit>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    142f:	f7 f6                	div    %esi
    1431:	0f b6 92 e0 17 00 00 	movzbl 0x17e0(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    15a8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
    15ab:	b8 d6 17 00 00       	mov    $0x17d6,%eax
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1631:	a1 c0 1a 00 00       	mov    0x1ac0,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  freep = p;
    1689:	a3 c0 1a 00 00       	mov    %eax,0x1ac0
}
    168e:	5b                   	pop    %ebx
    168f:	5e                   	pop    %esi
    1690:	5f                   	pop    %edi
  ...
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
    16ad:	a3 c0 1a 00 00       	mov    %eax,0x1ac0
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    16cc:	8b 15 c0 1a 00 00    	mov    0x1ac0,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    1721:	39 05 c0 1a 00 00    	cmp    %eax,0x1ac0
  ...
  return freep;
    174b:	8b 15 c0 1a 00 00    	mov    0x1ac0,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    176c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
    176f:	89 15 c0 1a 00 00    	mov    %edx,0x1ac0
      return (void*)(p + 1);
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    1786:	c7 05 c0 1a 00 00 c4 	movl   $0x1ac4,0x1ac0
    178d:	1a 00 00 
    1790:	c7 05 c4 1a 00 00 c4 	movl   $0x1ac4,0x1ac4
    1797:	1a 00 00 
    base.s.size = 0;
    179a:	b8 c4 1a 00 00       	mov    $0x1ac4,%eax
    179f:	c7 05 c8 1a 00 00 00 	movl   $0x0,0x1ac8
    17a6:	00 00 00 
